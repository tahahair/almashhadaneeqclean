  ...
  const steps = [
    {
      Icon: Camera,
      title: "التقط صورتك",
      description: "صورة واحدة تفتح لك باب التحول",
    ...
    },
    {
      Icon: Brain,
      title: "تحليل ذكي",
      description: "يحلل الذكاء الاصطناعي ملامحك بدقة",
    ...
    },
    {
      ...
      description: "شاهد شكلك الجديد في 60 ثانية",
    ...
    },
    {
      Icon: Calendar,
      title: "احجز موعدك",
      description: "اتخذ قرارك بثقة واحجز مباشرة",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 py-16 px-4">
      ...
      <div className="max-w-7xl mx-auto mb-24 relative">
        ...
        <div dir="rtl" className="relative text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-orange-600 to-amber-600 text-transparent bg-clip-text leading-tight leading-relaxed py-2">
          60 ثانية     
            <br />
            تغير مستقبل عملائك
          </h1>
          <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto leading-loose">
            اكتشف كيف تحول المترددين إلى عملاء واثقين من قرارهم في دقيقة واحدة
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto mb-24">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-gray-800">
          نتائج حقيقية من عيادات تستخدم التقنية
        </h2>
        ...
        <div className="relative">
          ...
          <div className="relative bg-white rounded-2xl p-12 shadow-2xl border border-orange-200">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              جاهز لتجربة قوة الذكاء الاصطناعي في عيادتك؟
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              ابدأ اليوم وشاهد كيف يمكن لتقنيتنا تحويل المترددين إلى عملاء واثقين
            </p>
